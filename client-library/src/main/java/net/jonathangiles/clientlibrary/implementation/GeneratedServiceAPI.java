...
@ServiceInterface(name = "GeneratedServiceAPI")
...
//        }
    ...
    @HttpRequestInformation(method = GET, path = "/keys")
    List<String> getKeys(@HostParam("endpoint") String endpoint,
    ...
    void setKey(@HostParam("endpoint") String endpoint,
                @QueryParam("nameParam") String keysName,
                @HeaderParam("fooValueHeader") String fooValue,
